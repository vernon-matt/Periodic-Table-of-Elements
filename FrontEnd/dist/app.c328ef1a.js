...
function Elements(elementlist) {
  return "\n    <h1>Elements</h1>\n    <ul>\n        ".concat(elementlist.map(function (element) {
    return "\n            <div class=\"".concat(element.class, " Group").concat(element.groupId, " Period").concat(element.periodId, "\">\n                <p>").concat(element.atomicNumber, "</p>\n                <p>").concat(element.symbol, "</p>\n                <p>").concat(element.atomicWeight, "</p>\n                <p>").concat(element.name, "</p>\n            </div>\n        ");
  }), "\n    ");
}
