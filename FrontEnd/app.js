...
function infoBox() {
    document.getElementById('component1').addEventListener('mouseover', function() {
        if (event.target.classList.contains("ele")) {
            ...
            ApiAction.getRequest("https://192.168.0.32:5001/api/elements/element/"+ elementId,
              selement => {
...
function elements(){
    ...
    elements.addEventListener('click', function(){
        ApiAction.getRequest("https://192.168.0.32:5001/api/elements", elementlist => {
...
function elementByClass(){
    document.querySelector('.navbar').addEventListener("click", function() {
        if (event.target.classList.contains("select_element_by_class")) {
          ...
          console.log(element)
          ApiAction.getRequest("https://192.168.0.32:5001/api/elements/"+ element,
            elementlist => {
...
function addElement2(){ 
    document.querySelector('#component1').addEventListener("click", function() {
        if (event.target.classList.contains("addele1")) {
            ...
            ApiAction.putRequest("https://192.168.0.32:5001/api/Elements/"+ elementId, data,
            selement => {
